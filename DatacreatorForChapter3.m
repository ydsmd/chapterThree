...
num = 1;
%% 第一组数据
Savepath = 'D:\研究生\毕设\大论文\第四章\Code\dataset_210m_0.55L_A1_W1\';
position = 0.55*L;
if ~exist(Savepath)
    mkdir(Savepath);
end
...
num=num+1;
%% 第二组数据
Savepath = 'D:\研究生\毕设\大论文\第四章\Code\dataset_210m_0.45L_A1_W1\';
position = 0.45*L;
if ~exist(Savepath)
    mkdir(Savepath);
end
...
%% 第三组数据
Savepath = 'D:\研究生\毕设\大论文\第四章\Code\dataset_210m_0.5L_A1_W1\';
position = 0.5*L;
if ~exist(Savepath)
    mkdir(Savepath);
end
...
num=num+1;
%% 第四组数据
Savepath = 'D:\研究生\毕设\大论文\第四章\Code\dataset_210m_0.55L_A1_W2\';
position = 0.55*L;
if ~exist(Savepath)
    mkdir(Savepath);
end
...
num=num+1;
%% 第五组数据
Savepath = 'D:\研究生\毕设\大论文\第四章\Code\dataset_210m_0.45L_A1_W2\';
position = 0.45*L;
if ~exist(Savepath)
    mkdir(Savepath);
end
...
%% 第六组数据
Savepath = 'D:\研究生\毕设\大论文\第四章\Code\dataset_210m_0.5L_A1_W2\';
position = 0.5*L;
if ~exist(Savepath)
    mkdir(Savepath);
end
